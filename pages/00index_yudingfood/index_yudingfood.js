 // pages/00index_yudingfood/index_yudingfood.js
Page({
  ...
  submit: function (e) {
    wx.navigateTo({
      url: '../00index_yuyuexiadan/index_yuyuexiadan', //跳转到下单页面
    })
  },
  // 外卖点菜类型切换
  ...
  tianjia: function (e) {
    ...
    gouwuche.push({ name: objname, money: obj, imgurl: objsrc, num: 1 })//添加到购物车
    if(numbers<0){
      numbers=0;
    }
  ...
  jian: function (e) {
    ...
    var num = this.data.gouwuche[shopIndex].num;
